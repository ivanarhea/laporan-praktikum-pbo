 ...
 * @author MSI GAMING
 */
public class TampilGui1841720189Rhea extends javax.swing.JFrame {
    DefaultTableModel TabMahasiswa;
    InputData1841720189Rhea DataMahasiswa;

    /**
     * Creates new form TampilGui
     */
    public TampilGui1841720189Rhea() {
        DataMahasiswa = new InputData1841720189Rhea();
        initComponents();
        LihatDataMahasiswa();
    }
    ...
    public final void LihatDataMahasiswa() {
        ...
        int i = 0;
        for(Mahasiswa1841720189Rhea mhs: DataMahasiswa.getData()) {
    ...
    private void jTextAlamatActionPerformed(java.awt.event.ActionEvent evt) {                                            
        // TODO add your handling code here:
    }                                           

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        DataMahasiswa.isiDataRhea(jTextFieldNim.getText(), jTextFieldNama.getText(), jTextAlamat.getText());
        LihatDataMahasiswa();
    }                                        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TampilGui1841720189Rhea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TampilGui1841720189Rhea().setVisible(true);
            }
        });
    }
