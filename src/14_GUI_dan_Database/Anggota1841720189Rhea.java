...
public class Anggota1841720189Rhea {
    ...
    public Anggota1841720189Rhea(String nama, String alamat, String telepon) {
        this.nama = nama;
        this.alamat = alamat;
        this.telepon = telepon;
    }
    
    public Anggota1841720189Rhea getById(int id) {
        Anggota1841720189Rhea agt = new Anggota1841720189Rhea();
        ResultSet rs = DBHelper1841720189Rhea.selectQuery("SELECT * FROM anggota " + " WHERE idAnggota = '" + id + "'");

        try {
            while (rs.next()) {
                agt = new Anggota1841720189Rhea();
    ...
    public ArrayList<Anggota1841720189Rhea> getAll() {
        ...
        ResultSet rs = DBHelper1841720189Rhea.selectQuery("SELECT * FROM anggota");
    ...
    public ArrayList<Anggota1841720189Rhea> search(String keyword) {
        ArrayList<Anggota1841720189Rhea> ListAnggota = new ArrayList();
    ...
    public void save(){
        if(getById(idAnggota).getIdAnggota() == 0){
            String SQL = "Insert into anggota (nama,alamat,telepon) values(" 
                    ...
                    + " '"+this.telepon+"' "
                    + " )";
                    this.idAnggota = DBHelper1841720189Rhea.insertQueryGetId(SQL);
        }else{
