...
import javax.swing.table.DefaultTableModel;
    ...
    public FrmAnggota1841720189Rhea() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    public void tampilkanData() {
        ...
        ArrayList<Anggota1841720189Rhea> list = new Anggota1841720189Rhea().getAll();
        Object rowData[] = new Object[4];
        
        tblAnggota.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for(Anggota1841720189Rhea agt : list) {
    ...
    public void cari(String keyword) {
        String[] kolom = {"ID", "Nama", "Alamat", "Telepon"};
        ArrayList<Anggota1841720189Rhea> list = new Anggota1841720189Rhea().search(keyword);
        Object rowData[] = new Object[4];
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        agt.setIdAnggotaEla(Integer.parseInt(txtIdAnggota.getText()));
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Anggota1841720189Rhea agt = new Anggota1841720189Rhea().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        agt.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAnggota1841720189Rhea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAnggota1841720189Rhea().setVisible(true);
            }
        });
    }
