 ...
 * 
 */
public class FrmBuku1841720189Rhea extends javax.swing.JFrame {

    /**
     *      */
    public FrmBuku1841720189Rhea() {
        initComponents();
        initComponents();
        tampilkanData();
    ...
    public void tampilkanData() {
        ...
        ArrayList<Buku1841720189Rhea> list = new Buku1841720189Rhea().getAll();
    ...
    public void cari(String keyword) {
        String[] kolom = {"ID", "Kategori", "Judul", "Penulis", "Penerbit"};
        ArrayList<Buku1841720189Rhea> list = new Buku1841720189Rhea().search(keyword);
        Object rowData[] = new Object[5];
        
        tblBuku.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for(Buku1841720189Rhea buku : list) {
    ...
    public void tampilkanCmbKategori () {
        cmbKategori.setModel(new DefaultComboBoxModel(new Kategori1841720189Rhea().getAll().toArray()));
    }
    /**
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        buku.setKategori((Kategori1841720189Rhea)cmbKategori.getSelectedItem());
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Buku1841720189Rhea buku = new Buku1841720189Rhea().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        buku.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmBuku1841720189Rhea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmBuku1841720189Rhea().setVisible(true);
            }
        });
    }
