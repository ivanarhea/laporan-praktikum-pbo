 ...
 */
package jb.pkg14;;
import backend1841720189Rhea.Anggota1841720189Rhea;
import backend1841720189Rhea.Peminjaman1841720189Rhea;
import backend1841720189Rhea.Buku1841720189Rhea;
 ...
 * @author Ela Widya
 */
public class FrmPeminjaman1841720189Rhea extends javax.swing.JFrame {

    /**
     * Creates new form FrmPeminjaman1841720126Ela
     */
    public FrmPeminjaman1841720189Rhea() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    public void tampilkanData(){
        ...
        ArrayList<Peminjaman1841720189Rhea> list = new Peminjaman1841720189Rhea().getAllEla();
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            rowData[1] = list.get(i).getAnggotaEla().getNama();
            rowData[2] = list.get(i).getBukuEla().getJudul();
    ...
    public void cariAnggota(String keyword){
        Anggota1841720189Rhea anggota = new Anggota1841720189Rhea().getById(Integer.parseInt(keyword));
        jLabel6.setText("Nama Anggota : "+anggota.getNama());
    }
    
    public void cariBuku(String keyword){
        Buku1841720189Rhea buku = new Buku1841720189Rhea().getById(Integer.parseInt(keyword));
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        Peminjaman1841720189Rhea pmj = new Peminjaman1841720189Rhea();
        pmj.setIdpeminjamanEla(Integer.parseInt(txtIdPeminjaman.getText()));
        
        Anggota1841720189Rhea anggota = new Anggota1841720189Rhea().getById(Integer.parseInt(txtIdAnggota.getText()));
        Buku1841720189Rhea buku = new Buku1841720189Rhea().getById(Integer.parseInt(txtIdBuku.getText()));
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Peminjaman1841720189Rhea pmj = new Peminjaman1841720189Rhea().getByIdEla(Integer.parseInt(model.getValueAt(row, 0).toString()));
        pmj.deleteEla();
        kosongkanForm();
        tampilkanData();
    ...
    private void tblPeminjamanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPeminjamanMouseClicked
        ...
        int row = tblPeminjaman.getSelectedRow();
        Peminjaman1841720189Rhea pmj = new Peminjaman1841720189Rhea();
        pmj = pmj.getByIdEla(Integer.parseInt(model.getValueAt(row, 0).toString()));
        
        txtIdPeminjaman.setText(String.valueOf(pmj.getIdpeminjamanEla()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPeminjaman1841720189Rhea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPeminjaman1841720189Rhea().setVisible(true);
            }
        });
    }
