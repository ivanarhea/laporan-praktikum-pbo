...
public class Peminjaman1841720189Rhea {
    private int idpeminjaman;
    private Anggota1841720189Rhea anggota = new Anggota1841720189Rhea();
    private Buku1841720189Rhea buku = new Buku1841720189Rhea();
    private String tanggalpinjam;
    private String tanggalkembali;

    public Peminjaman1841720189Rhea() {
    }

    public Peminjaman1841720189Rhea(Anggota1841720189Rhea anggota, Buku1841720189Rhea buku, String tanggalpinjam, String tanggalkembali) {        
    ...
    public Anggota1841720189Rhea getAnggota() {
        return anggota;
    }

    public void setAnggota(Anggota1841720189Rhea anggota) {
        this.anggota = anggota;
    }

    public Buku1841720189Rhea getBuku() {
        return buku;
    }

    public void setBuku(Buku1841720189Rhea buku) {
        this.buku = buku;
    }
    ...
    public Peminjaman1841720189Rhea getById(int id){
        Peminjaman1841720189Rhea peminjaman = new Peminjaman1841720189Rhea();
        ResultSet rs = DBHelper1841720189Rhea.selectQuery("SELECT "
        ...
        try {
            while(rs.next()){
                peminjaman = new Peminjaman1841720189Rhea();
    ...
    public ArrayList<Peminjaman1841720189Rhea> getAll(){
        ArrayList<Peminjaman1841720189Rhea> ListPeminjaman = new ArrayList();
        ResultSet rs = DBHelper1841720189Rhea.selectQuery("SELECT "
                                        +"      p.idpeminjaman AS idpeminjaman, "
                                        +"      p.tanggalpinjam AS tanggalpinjam, "
                                        +"      p.tanggalkembali AS tanggalkembali, "
    ...
    public ArrayList<Peminjaman1841720189Rhea> search(String keyword){
        ArrayList<Peminjaman1841720189Rhea> ListPeminjaman = new ArrayList();
        ResultSet rs = DBHelper1841720189Rhea.selectQuery("SELECT "
                                        +"      p.idpeminjaman AS idpeminjaman, "
                                        +"      p.tanggalpinjam AS tanggalpinjam, "
    ...
    public void save(){
        if(getByIdEidpeminjaman).getIdpeminjaman()== 0){
            String SQL = "INSERT INTO peminjaman (idanggota, idbuku, tanggalpinjam, tanggalkembali) VALUES("
                    ...
                    +"      '"+ this.tanggalkembali + "' "
                    +"      )";
            this.idpeminjaman = DBHelper1841720189Rhea.insertQueryGetId(SQL);
