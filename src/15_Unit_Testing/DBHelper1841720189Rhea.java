...
public class DBHelper1841720189Rhea {
    ...
    public static int insertQueryGetId(String mQuery) {
        bukaKoneksi();
        int mNum = 0;
        int mResutl = -1;
    ...
    public static boolean executeQuery(String mQuery) {
        bukaKoneksi();
    ...
    public static ResultSet selectQuery(String mQuery) {
        bukaKoneksi();
        ResultSet mRs = null;
        try {
            Statement mStmt = sKoneksi.createStatement();
