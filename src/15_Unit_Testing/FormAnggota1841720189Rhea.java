 ...
 * @author Andy
 */
public class FormAnggota1841720189Rhea extends javax.swing.JFrame {

    /**
     * Creates new form FormAnggota1841720002Andy
     */
    public FormAnggota1841720189Rhea() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    public void tampilkanData(){
        ...
        for (Anggota1841720189Rhea ang : list) {
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Anggota1841720189Rhea ang = new Anggota1841720189Rhea().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        ang.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAnggota1841720189Rhea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormAnggota1841720189Rhea().setVisible(true);
            }
        });
    }
