...
public class FormKategori1841720189Rhea extends javax.swing.JFrame {

    /**
     * Creates new form FormKategori1841720002Andy
     */
    public FormKategori1841720189Rhea() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    public void tampilkanData(){
        ...
        ArrayList<Kategori1841720189Rhea> list = new Kategori1841720189Rhea().getAll();
        Object rowData[] = new Object[3];
        
        tblKategori.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for (Kategori1841720189Rhea kat : list) {
    ...
    public void cari (String keyword){
        String[] kolom = {"ID", "Nama", "Keterangan"};
        ArrayList<Kategori1841720189Rhea> list = new Kategori1841720189Rhea().search(keyword);
        Object rowData[] = new Object[3];
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Kategori1841720189Rhea kat = new Kategori1841720189Rhea().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        kat.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormKategori1841720189Rhea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormKategori1841720189Rhea().setVisible(true);
            }
        });
    }
